...
const InvoiceDialoag = ({ invoice, setInvoice }: InvoiceDialoagProps) => {
  ...
  const handleClick = () => {
    ...
    if (element) {
      html2pdfModule.default().from(element).save(); // Access the default function and call `.from().save()`
      setInvoice(null);
    }
  };
  ...
  return (
   <div>
   <Button onClick={handleClick} className='w-full' disabled = {invoice === null}>Download</Button>
   { invoice &&  (
            ...
            <div className="box-border border border-black">
               ...
               <div className="p-2">
                  <p className="text-xs">
                     ...
                     Wastage Charges, GST and other taxes (as applicable).
                     Upon specific request detailed statement will be
                     provided.
                     <br />
                     ...
                     *CN(Credit note) & have read & accepted all terms and
                     conditions of said CN & further acknowledge the
                     ...
                     address & contact details is available on the website
                     www.bis.gov.in
                     <br />
