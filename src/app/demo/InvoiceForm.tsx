         ...
         <div className='box-border border border-black'>
               ...
               <table className="w-full border-b border-black py-2 text-[12px]">
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td className="px-2">₹{invoice.rate.Platinum95}</td>
                     </tr>
                  </tbody>
               </table>
                  ...
                  <tbody>
                     {invoice.products.map((product) => (
                        <tr key={product.id}>
                           ...
                           <td className="px-1 py-1">{product.netQuantity}N</td>
                           <td className="px-1 py-1">{product.GrossWeight}</td>
                           <td className="px-1 py-1">
                              {product.GrossProductPrice}
                           </td>
                           <td className="px-1 py-1">{product.netStoneWeight}</td>
                           <td className="px-1 py-1">{product.stonePrice}</td>
                           <td className="px-1 py-1">
                              {(product.MakingCharge * product.GrossProductPrice) /
                                 100}
                           </td>
                           <td className="px-1 py-1">
                              {(product.discount * product.GrossProductPrice) /
                                 100}
                           </td>
                           <td className="px-1 py-1">
                           ...
                           <td className="px-1 py-1">{product.productValue}</td>
                        </tr>
                     ))}
                     <tr className="border-t border-black">
                        <td className="px-1 py-1 font-extrabold">Total</td>
                        ...
                        <td className="px-1 py-1 font-extrabold">
                           ₹
                           {invoice.products.reduce(
                              (sum, product) => sum + product.GrossProductPrice,
                              0,
                           )}
                        </td>
                        <td className="px-1 py-1 font-extrabold">
                           {invoice.products.reduce(
                              (sum, product) => sum + product.netStoneWeight,
                              0,
                           )}
                        </td>
                        <td className="px-1 py-1 font-extrabold">
                        ...
                        <td className="px-1 py-1 font-extrabold">
                           {invoice.products.reduce(
                              (sum, product) => sum + product.productValue,
                              0,
                           )}
                        </td>
                     </tr>
            ...
            <div className="grid grid-cols-2 border-b-2 border-black">
               <div className="border-r border-r-black">
                  <h3 className="w-full p-2 font-bold">Payment details</h3>
                  <table className="w-full">
                     <thead className="border-b border-t border-black py-9 text-xs">
                        <tr className="flex w-full justify-between">
                           <th className="flex-1 px-2 text-start">Payment Mode</th>
                           <th className="flex-1 px-2 text-start">
                              Customer name
                           </th>
                           <th className="flex-1 px-2 text-start">Amount</th>
                        </tr>
                     </thead>
                     <tbody>
                        <tr className="flex w-full justify-between">
                           <td className="flex-1 px-2 text-start">Cash</td>
            ...
            <div className="p-2">
               <p className="text-xs">
                  ...
                  Product Making Charges/ Wastage Charges, GST and other taxes (as
                  applicable). Upon specific request detailed statement will be
                  provided.
                  <br />
                  2.Weight verified and Received product in good condition .
                  <br />
                  3.I hereby confirm the purity,weight and value of *CN(Credit
                  note) & have read & accepted all terms and conditions of said CN
                  & further acknowledge the amount stated is correct and accurate.
                  <br />
                  4.NA - Not Applicable, since the product is sold by piece /
                  number.
                  <br />
                  5.If other (non-precious/semiprecious) materials are included in
                  the product, the product gross weight is inclusive of other
                  material weight.
                  <br />
                  6.The consumer can get the purity of hallmarked jewllery /
                  artifacts verified from any of the BIS recognised A & H centre
                  <br />
            ...
            <div className="flex border-b border-black">
               <div className="w-1/2 border-r-2 border-black p-2">
                  ...
                  <p className='font-bold my-4'>Customer Signature: </p>
               </div>
               <div className="w-1/2 p-2">
                  <p ><span className='font-bold'>For: </span> </p>
                  <p className='font-bold my-4'>Authorized Signature: </p>
               </div>
            </div>
         </div>
      </div>
